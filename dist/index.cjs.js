    ...
    [
      ...
      },
      {
        ...
        value: function getBestImageForType(srcType) {
          ...
          if (
            srcType === 'mainSrc' &&
            this.isImageLoaded(this.props.originalSrc)
          ) {
            imageSrc = this.props.originalSrc; // Use hi-res image if available
      ...
      },
      {
        ...
        value: function getSrcTypes() {
          return [
            {
              name: 'originalSrc',
              keyEnding: 'o'.concat(this.keyCounter),
              autoload: false,
            },
            {
              name: 'mainSrc',
      ...
      },
      {
        ...
        value: function changeZoom(zoomLevel, clientX, clientY) {
          ...
          this.loadImage('originalSrc', this.props.originalSrc, function() {
            _this8.forceUpdate();
          });
        ...
        value: function handleOuterMousewheel(event) {
          ...
          if (actionDelay !== 0) {
            this.wheelActionTimeout = this.setTimeout(function() {
              _this9.wheelActionTimeout = null;
            }, actionDelay);
          }
        },
      },
      ...
      },
      {
        ...
        value: function filterPointersBySource() {
          ...
          this.pointerList = this.pointerList.filter(function(_ref2) {
            ...
            return source === _this10.eventsSource;
          });
        },
      },
      {
      ...
      },
      {
        ...
        value: function loadImage(srcType, imageSrc, done) {
          ...
          inMemoryImage.onerror = function(errorEvent) {
            _this14.props.onImageLoadError(imageSrc, srcType, errorEvent); // failed to load so set the state loadErrorStatus
          ...
          inMemoryImage.onload = function() {
            _this14.props.onImageLoad(imageSrc, srcType, inMemoryImage);

            _this14.imageCache[imageSrc] = {
              loaded: true,
        ...
        value: function loadAllImages() {
          ...
          var generateLoadDoneCallback = function generateLoadDoneCallback(
            ...
            return function(err) {
              ...
              if (_this15.props[srcType] !== imageSrc || _this15.didUnmount) {
                return;
          ...
          this.getSrcTypes().forEach(function(srcType) {
            ...
            if (props[type] && _this15.state.loadErrorStatus[type]) {
            ...
            if (props[type] && !_this15.isImageLoaded(props[type])) {
              _this15.loadImage(
                type,
                props[type],
      ...
      },
      {
        ...
        value: function requestClose(event) {
          ...
          var closeLightbox = function closeLightbox() {
            return _this16.props.onCloseRequest(event);
          };
...
ReactImageLightbox.propTypes = {
  ...
  originalSrc: PropTypes__default['default'].string,
